...
class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        //ex4: wood-like material  to change color: setAmbient(%r,%g,%b,alpha) percentagem de rbg!!!
        this.wood = new CGFappearance(this);
        this.wood.setAmbient(0.7922, 0.6431, 0.4471, 1.0);
    ...
    display() {
        ...
        this.setGlobalAmbientLight(this.setAmbientLight,this.setAmbientLight,this.setAmbientLight,1);
